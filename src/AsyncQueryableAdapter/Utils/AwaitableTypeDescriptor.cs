...
namespace AsyncQueryableAdapter.Utils
{
    ...
    public sealed class AwaitableTypeDescriptor
    {
        ...
        private static readonly ConditionalWeakTable<Type, AwaitableTypeDescriptor>.CreateValueCallback _buildTypeDescriptor
            = BuildTypeDescriptor;
        ...
        public static AwaitableTypeDescriptor GetTypeDescriptor(Type type)
        {
            ...
            var result = _cache.GetValue(type, _buildTypeDescriptor);
            return result;
        }
