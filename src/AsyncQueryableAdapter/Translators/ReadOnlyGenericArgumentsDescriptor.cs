...
{
    internal readonly ref struct ReadOnlyGenericArgumentsDescriptor
    {
        public ReadOnlyGenericArgumentsDescriptor(
        ...
        public ReadOnlySpan<Type> GenericArguments { get; }

        public ReadOnlySpan<TranslatedGenericArgument> TranslatedGenericArguments { get; }
