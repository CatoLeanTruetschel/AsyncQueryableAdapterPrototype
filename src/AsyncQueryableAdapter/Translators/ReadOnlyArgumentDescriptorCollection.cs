...
{
    internal readonly struct ReadOnlyArgumentDescriptorCollection : IReadOnlyList<ReadOnlyArgumentDescriptor>
    {
        ...
        public ReadOnlyArgumentDescriptorCollection(
        ...
        public ReadOnlyArgumentDescriptor this[int index]
        {
            get
            {
        ...
        IEnumerator<ReadOnlyArgumentDescriptor> IEnumerable<ReadOnlyArgumentDescriptor>.GetEnumerator()
        {
        ...
        public struct Enumerator : IEnumerator<ReadOnlyArgumentDescriptor>
        {
            private readonly ReadOnlyArgumentDescriptorCollection _owner;
            private int _index;

            public Enumerator(in ReadOnlyArgumentDescriptorCollection owner)
            {
                _owner = owner;
                _index = -1;
            }

            public ReadOnlyArgumentDescriptor Current
            {
                get
                {
